...
Pod::Spec.new do |s|
  ...
  # Or just: s.author    = "Xiaoye__220"
  # s.authors            = { "Xiaoye__220" => "576934532@qq.com" }
  # s.social_media_url   = "http://twitter.com/Xiaoye__220"
  ...
  s.source_files  = "CoreDataExtensions/Code/*"
